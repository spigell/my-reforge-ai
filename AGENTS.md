...
- **Type Aliases:** Define object shapes with the `type` keyword instead of `interface` (e.g., `type Foo = { ... }`). This keeps the codebase consistent and avoids duplicate declaration pitfalls.
