...
#####################################################################
**If the file {{task.task_dir}}/plan.md absent => initial run**
If task.review_required is true:
...
- Create/update the planning doc without calling **@spigell**. End your comment with “No review required”.
...
#####################################################################
**If there is already file {{task.task_dir}}/plan.md => not initial run**

- Read latest reviewer comments got from mcp call get_pull_request or get_issue_comments.
- Print all comments in message.
